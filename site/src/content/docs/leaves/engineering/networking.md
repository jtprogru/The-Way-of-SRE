---
title: Networking
description: Сетевой стек как фундамент надёжности — TCP/IP, DNS, TLS, gRPC, service mesh, resilience patterns
---
...
- Julia Evans — **[Bite Size Networking](https://wizardzines.com/zines/bite-size-networking/)** zines. Очень доступные иллюстрации TCP-handshake, DNS, etc.
