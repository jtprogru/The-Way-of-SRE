...
Инженерная сторона SLO: **определение SLI**, формализация SLO, инструментирование сервиса, расчёт error budget. Не путать с `SLO Governance` (Culture/IT Management — организационная сторона: SLA с внешними, политика бюджета) и `SLO Review Ritual` (Practices — регулярный ритуал ревью).
...
- **[SLI-based Alerting](/The-Way-of-SRE/leaves/engineering/sli-based-alerting/)** — алертинг строится поверх SLO Engineering.
- **[SLO / Budget Review](/The-Way-of-SRE/leaves/culture/slo-budget-review/)** — ритуал, потребляющий данные SLO Engineering.
