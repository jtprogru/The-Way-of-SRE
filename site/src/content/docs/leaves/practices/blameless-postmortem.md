...
description: Ритуал разбора инцидента — timeline, contributing factors, action items с владельцем и дедлайном
---
...
**Ритуал** разбора инцидента: timeline, contributing factors, action items с владельцем и дедлайном. Не путать с [Postmortem Culture](/The-Way-of-SRE/leaves/culture/postmortem-culture/) (Culture/Learning Delivery — **норма** blameless); здесь — про **процесс**, который опирается на эту норму.
...
- Jeli.io — **[The Post-Incident Guide](https://www.jeli.io/post-incident-guide)**. Практичный гайд по проведению постмортема как разговора.

### Инструменты

- Шаблоны: **[Google SRE template](https://sre.google/sre-book/example-postmortem/)**, **[PagerDuty templates](https://postmortems.pagerduty.com/templates/)**.
...
- **[Postmortem Culture](/The-Way-of-SRE/leaves/culture/postmortem-culture/)** — норма, на которой держится этот ритуал.
- **[Incident Response](/The-Way-of-SRE/leaves/practices/incident-response/)** — постмортем — after-action для инцидента.
