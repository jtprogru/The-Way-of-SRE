...
- **[SLI-based Alerting](/The-Way-of-SRE/leaves/engineering/sli-based-alerting/)** — алерты на burn rate дают входные данные для SLO Review.
- **[Blameless Postmortem](/The-Way-of-SRE/leaves/practices/blameless-postmortem/)** — постмортемы выявляют конкретные источники бюджет-сжигания.
- **[Runbooks](/The-Way-of-SRE/leaves/culture/runbooks/)** — runbooks по SLO-нарушениям позволяют отрабатывать инциденты без расходования бюджета на ручной разбор.
