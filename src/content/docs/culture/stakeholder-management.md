...
- **[Cost Management](/The-Way-of-SRE/engineering/cost-management/)** — cost-translation — отдельная подобласть stakeholder management; finance — один из ключевых non-engineering stakeholder'ов, чей язык требует отдельной подготовки.
