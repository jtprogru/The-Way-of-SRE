...
- **[Blameless Postmortem](/The-Way-of-SRE/practices/blameless-postmortem/)** — ритуал, опирающийся на эту культурную норму. Здесь — норма, там — процедура.
- **[Incident Response](/The-Way-of-SRE/practices/incident-response/)** — постмортем — то, что происходит **после** incident response; качество timeline постмортема прямо зависит от качества фиксации событий в моменте.
- **[SLO / Budget Review](/The-Way-of-SRE/culture/slo-budget-review/)** — постмортемы выявляют источники сжигания бюджета; ритуал ревью — точка, где lessons learned превращаются в приоритеты.
- **[Runbooks](/The-Way-of-SRE/culture/runbooks/)** — каждый постмортем тянет за собой правку runbook; иначе вывод остаётся незакреплённым.
- **[Dev Team Partnership](/The-Way-of-SRE/culture/dev-team-partnership/)** — совместный разбор с продуктовой командой: без него партнёрство не переживает первый же тяжёлый инцидент.
- **[Game Day / Chaos Drills](/The-Way-of-SRE/culture/game-day/)** — находки с game day разбираются в формате постмортема; предпосылка внедрения — работающая норма blameless.
- **[Postmortem Database](/The-Way-of-SRE/culture/postmortem-database/)** — норма разбора (этот лист) vs система хранения и извлечения уроков. Без культуры database заполняется поверхностными документами; без database культура теряет 60-70% долгосрочной ценности.
