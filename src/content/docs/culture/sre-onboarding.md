...
- **[Runbooks](/The-Way-of-SRE/culture/runbooks/)** — runbook — ключевой artefact onboarding; качество runbook прямо влияет на time-to-on-call.
...
- **[Incident Response](/The-Way-of-SRE/practices/incident-response/)** — главный навык, под который готовит onboarding; supervised on-call — мост от curriculum к реальной ротации.
...
- **[Service Ownership](/The-Way-of-SRE/culture/service-ownership/)** — service catalog — точка входа onboardee в production.
- **[Career Ladders](/The-Way-of-SRE/culture/career-ladders/)** — onboarding curriculum обычно maps к L3 → L4 progression в первый год.
- **[Communities of Practice](/The-Way-of-SRE/culture/communities-of-practice/)** — после первых 12 недель CoP — место, где новый инженер находит cross-team peer learning.
- **[Game Day / Chaos Drills](/The-Way-of-SRE/culture/game-day/)** — Wheel of Misfortune для onboardee — частный случай. Здесь — сценарий первых недель; там — continuous calibration команды.
- **[Team Topologies](/The-Way-of-SRE/culture/team-topologies/)** — сценарий onboarding зависит от того, в какую topology попадает новый инженер (embedded / platform / enabling). Без понимания topology curriculum получается универсальным и неточным.
