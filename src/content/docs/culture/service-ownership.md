...
- **[Cost Management](/The-Way-of-SRE/engineering/cost-management/)** — каталог содержит метаданные о затратах: текущий spend, budget, trend. Cost ownership = service ownership.
- **[Vendor Management](/The-Way-of-SRE/practices/vendor-management/)** — каталог содержит upstream vendor dependencies сервиса; vendor incident playbook привязан к owner.
