...
- **[SLI-based Alerting](/The-Way-of-SRE/engineering/sli-based-alerting/)** — обязательная пара: каждый SLO-алерт ведёт к runbook; алерт без runbook удаляется как фоновый шум.
