...
- John Micco — **[Flaky Tests at Google and How We Mitigate Them](https://testing.googleblog.com/2016/05/flaky-tests-at-google-and-how-we.html)** (Google Testing Blog, 2016). Масштаб проблемы в цифрах: 1.5% всех прогонов дают flaky-результат, почти 16% тестов хоть раз мигали, 84% переходов pass → fail оказываются flake'ом, а не регрессией. Держу под рукой как аргумент для тех, кто считает мигающий тест мелочью.
