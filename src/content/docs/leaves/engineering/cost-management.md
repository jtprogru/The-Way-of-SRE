...
- **[Service Ownership](/The-Way-of-SRE/leaves/culture/service-ownership/)** — каталог сервиса содержит данные о стоимости: owner, budget, current spend, trend.
- **[Stakeholder Management](/The-Way-of-SRE/leaves/culture/stakeholder-management/)** — cost-translation для finance — отдельный навык внутри stakeholder management; разговор с CFO требует unit economics, а не инженерных метрик.
- **[Cloud Providers](/The-Way-of-SRE/leaves/engineering/cloud-providers/)** — биллинговая модель провайдера — fundamental input в FinOps lifecycle; сервисы под управлением провайдера против self-hosted — центральный компромисс по деньгам.
