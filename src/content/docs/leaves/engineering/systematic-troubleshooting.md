...
- **Ветвь:** Engineering
- **Путь:** Reliability Engineering / Systematic Troubleshooting
- **SFIA-уровни:** 3, 4, 5, 6
- **Приоритет:** Must Have
- **Статус:** draft
:::
...
- Поднимает [Game Day](/The-Way-of-SRE/leaves/culture/game-day/) / wheel of misfortune как тренировку разбора: учебный инцидент отрабатывает методологию без production-риска.
...
- Brian Kernighan, Rob Pike — **[The Practice of Programming](https://www.cs.princeton.edu/~bwk/tpop.webpage/)** (Addison-Wesley, 1999). Глава 5 «Debugging» — короткий, но классический разбор: stack-trace reading, binary search в коде, «changes have probably broken things» как default-гипотеза.
...
- **[Game Day](/The-Way-of-SRE/leaves/culture/game-day/)** — тренировка методологии на fake-инциденте без production risk.
