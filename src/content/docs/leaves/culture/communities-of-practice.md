...
Граница: [SRE Onboarding](/The-Way-of-SRE/leaves/culture/sre-onboarding/) — процесс уровня организации для одного инженера; [Career Ladders](/The-Way-of-SRE/leaves/culture/career-ladders/) — словарь роста; этот лист — **ритуал обучения через границы команд**, который заполняет пространство между ними.
...
- **[Career Ladders](/The-Way-of-SRE/leaves/culture/career-ladders/)** — вести сообщество — типичное ожидание на L5 / L6+; ladder засчитывает вклад в CoP как доказательство влияния за пределами своей команды.
...
- **[Dev Team Partnership](/The-Way-of-SRE/leaves/culture/dev-team-partnership/)** — сообщество масштабирует SRE-практики за пределы текущей модели взаимодействия: в него приходят и SRE, и разработчики.
