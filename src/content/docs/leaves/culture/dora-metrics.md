---
title: DORA Metrics
description: Четыре метрики delivery-производительности команды (deployment frequency, lead time, change failure rate, время восстановления) — про разговор, не про дашборд
---
...
- DORA — **[Capabilities catalog](https://dora.dev/capabilities/)**. Больше трёх десятков практик, которые исследование выделяет как драйверы улучшения метрик; каталог растёт от года к году, в последних редакциях добавился блок про внедрение AI. Полезно как чек-лист «что попробовать», когда тренд застрял.
