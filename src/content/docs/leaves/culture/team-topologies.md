...
- Лист написан по первому изданию. Второе (2025) я целиком не читал: по описанию издателя platform team уточнена как platform grouping, когнитивная нагрузка поднята до принципа проектирования, а рамка расширена на трансформацию организации целиком. Сохранилась ли без изменений связка «четыре типа команд + три режима взаимодействия» и как перенумерованы главы — не проверено, поэтому номера глав из листа убраны. Кто читал второе издание — правки приветствуются PR'ом.
