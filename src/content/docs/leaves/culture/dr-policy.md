...
- Проектирует annual DR exercise: full-scale tabletop минимум раз в год + functional drill (реальный failover) раз в 6-12 месяцев. Тренировочная сторона разобрана в [Game Day / Chaos Drills](/The-Way-of-SRE/leaves/culture/game-day/).
...
- **[Game Day / Chaos Drills](/The-Way-of-SRE/leaves/culture/game-day/)** — annual DR exercise как полномасштабный game day. Здесь — policy и stakeholder map; там — тренировочная сторона проверки.
...
- **[Customer Communications](/The-Way-of-SRE/leaves/practices/customer-communications/)** — communication tree — часть DR policy; частота сообщений в зависимости от severity и выбор каналов живут на пересечении.
