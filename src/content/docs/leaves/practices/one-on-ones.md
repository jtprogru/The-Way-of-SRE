...
- **[Dev Team Partnership](/The-Way-of-SRE/leaves/culture/dev-team-partnership/)** — engagement contract включает 1:1 cadence между SRE и tech lead продуктовой команды; 1:1 через границу команд — паттерн партнёрства.
