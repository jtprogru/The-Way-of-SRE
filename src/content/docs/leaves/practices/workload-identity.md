...
- **[Athenz](https://www.athenz.io/)** (изначально Yahoo, сейчас под Linux Foundation) — ветеран темы, появившийся раньше SPIFFE. Реже выбирают для green-field, но встречается там, где инфраструктура строилась вокруг Yahoo-стека.
