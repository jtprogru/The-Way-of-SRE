...
- **[Incident Response](/The-Way-of-SRE/leaves/practices/incident-response/)** — IR = lifecycle одного инцидента; War Room = внутренняя механика фазы гашения, когда координируются несколько команд.
