...
- **[ChatOps](/The-Way-of-SRE/leaves/engineering/chatops/)** — современные инструменты для инцидентов (incident.io, Netflix Dispatch, FireHydrant) — Slack-native ChatOps; declare / coordinate / sitrep живут в chat с встроенным audit trail.
