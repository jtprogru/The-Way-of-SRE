...
**«No hero» culture: любой pager должен быть ack'нут.** «Я заметил проблему до того, как alert пришёл, разобрался сам» лишает команду visibility, нарушает audit trail, и через 6 месяцев один engineer становится bottleneck. Это политическая позиция, которую защищает team lead — без неё team health деградирует незаметно для всех, кроме hero.
