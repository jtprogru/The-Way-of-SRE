...
**L2-концепты:** Vulnerability Management · Security SLOs · Threat Modeling · Supply Chain Security · Secrets Management · Access Control & IAM · Workload Identity · Compliance Frameworks
...
Бюджет узлов: 1 корень + 8 L1 + 41 L2 = **50 узлов**.
