...
- **[Service Ownership](/The-Way-of-SRE/culture/service-ownership/)** — service catalog связывает каждый сервис с его уровнем toil; владельцы видят, какие сервисы дают непропорциональный toil.
- **[Runbooks](/The-Way-of-SRE/culture/runbooks/)** — runbook reduces toil, только если *хороший*. Плохой runbook увеличивает toil.
- **[Progressive Delivery](/The-Way-of-SRE/practices/progressive-delivery/)** — deploy operations — крупный класс toil; canary / feature flags / auto-rollback устраняют рутинные шаги.
- **[Infrastructure as Code](/The-Way-of-SRE/engineering/infrastructure-as-code/)** — IaC устраняет toil вокруг конфигураций; один из самых окупаемых шагов сокращения toil.
- **[Alert Fatigue Management](/The-Way-of-SRE/engineering/alert-fatigue-management/)** — alert fatigue — отдельный класс toil; SLO-based alerts с high signal-to-noise + runbook сокращают alert-toil сильнее, чем любая другая техника.
...
- **[Toil Automation](/The-Way-of-SRE/engineering/toil-automation/)** — пара: tracking даёт ranked list самого дорогого toil; automation реализует elimination. Здесь — про *что*; там — про *как*.
- **[Personal SRE Toolkit](/The-Way-of-SRE/engineering/personal-sre-toolkit/)** — самый дешёвый уровень toil reduction (alias / CLI / templates) для individual-level задач.
- **[ChatOps](/The-Way-of-SRE/engineering/chatops/)** — chat-driven форма team-level automation; снимает operational запросы через bot interface.
