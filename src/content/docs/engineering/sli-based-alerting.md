...
- **[SLO Engineering](/The-Way-of-SRE/engineering/slo-engineering/)** — пре-условие: SLI-based алертинг невозможен без определённых SLI/SLO.
- **Error Budget Burn Rate** *(TBD)* — техническая база расчёта burn rate, используется в alerting rule.
- **[Alert Fatigue Management](/The-Way-of-SRE/engineering/alert-fatigue-management/)** — соседний концепт: SLI-based подход — основной инструмент борьбы с alert fatigue, но не единственный.
