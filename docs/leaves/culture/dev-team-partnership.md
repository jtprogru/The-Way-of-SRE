---
name: Dev Team Partnership
branch: Culture
path: Relationship Management/Dev Team Partnership
sfia_levels: [3, 4, 5, 6]
priority: Must Have
status: draft
---
...
- **SLO / Budget Review** (`culture/slo-budget-review`) — главный регулярный ритуал, на котором partnership проявляется.
