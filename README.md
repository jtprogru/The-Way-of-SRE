...
Зависимости устанавливаются автоматически при первом запуске любой цели. CI зовёт те же цели, поэтому `make typecheck`, `make build` и `make style-ci` локально воспроизводят проверку на PR один в один.
