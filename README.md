...
- **[SRE Engineering](docs/sre-engineering.md)** — технические компетенции и стек. Главный объект — системы. **12 листьев** на полной глубине.
- **[SRE Practices](docs/sre-practices.md)** — операционные процессы и ритуалы. Главный объект — процесс. **10 листьев** на полной глубине.
